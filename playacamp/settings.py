"""
Django settings for playacamp project, on Heroku. For more info, see:
...
DEBUG = ('runserver' in sys.argv) or ('livereload' in sys.argv)
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'context_processors': [
                ...
                'main.context_processors.google_analytics.inject_google_analytics_tracking_id',
            ],
        },
    },
]

WSGI_APPLICATION = 'playacamp.wsgi.application'
...
AWS_STORAGE_BUCKET_NAME = os.environ.get('AWS_STORAGE_BUCKET_NAME', 'testbucket')
